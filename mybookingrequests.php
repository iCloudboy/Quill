                ...
                <?php
                    ...
                    try {
                        $sql = 'SELECT bookingID, forename, surname, bookingMessage, bookingDate, bookingTime FROM booking b 
                                ...
                                WHERE artistID = ? AND accepted IS NULL';
                            ...
                            while ($stmt->fetch()){
                                echo '<div class="request-content">
                                        ...
                                        <div class="request-retrieve-acceptdecline">
                                            <form method="POST" action="./app/functions/acceptdecline.func.php">
                                                <input type="hidden" value="' . $bookingID . '" name="bookingID">
                                                <input type="submit" name="accept" value="Accept">
                                                <input class="request-right-button" name="decline" type="submit" value="Decline">
                                            </form>
