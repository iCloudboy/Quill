...
function change_profile_image($user_id, $file_temp, $file_extension){
    ...
    $file_path = 'website/resources/images/picture/' . substr(md5(time()), 0, 10) . '.' . $file_extension; //generates a 10 character md5 hash from current time and uses it to name the picture.
